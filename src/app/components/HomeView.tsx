...
import {Krea, Home as HomeIcon, VideoAlt, ImageAlt, Image as ImageIcon, Enhancer, Edit, Brush, Video, EnhancerAlt, BrushAlt, EditAlt, Folder, CaretDownAlt, CaretDown, CaretLeft, CaretRight, Mic, MotionAlt, Train, Gallery, Support, Sun, Bell, Avatar} from "./icons";
import Slider from "./Slider";
import AccesibilityBar from "./AccesibilityBar";
  ...
  return (
    ...
    <>
   	<header className="w-full flex-wrap sm:flex-nowrap flex relative justify-between px-5 py-2.5">
				...
				<div className=" bg-[#f5f5f5] dark:bg-[#171717] hidden xs:flex  ml-auto rounded-[10px]  gap-[10px] p-1">
					<button className="py-2 px-4 bg-white dark:bg-black rounded-lg">
						<HomeIcon />
					</button>
